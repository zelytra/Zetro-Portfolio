  ...
  <section class="home-wrapper">
    ...
    <div class="services-wrapper">
      ...
      <section class="specialisation" v-if="service && service.cards">
        <SkillCard :title="getCard(0).title"
        ...
        <SkillCard :title="getCard(1).title"
        ...
        <SkillCard :title="getCard(2).title"
                   :content="getCard(2).content">
          <svg class="stroke" width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
